...
let lastName: string = 'Rangel';
let fullName: string = `meu nome é ${nameUser} ${lastName}`;
...
let languages: Array<string> = ['PHP', 'Java', 'C#', 'Python', 'JavaScript'];
let languages2: Array<string | number> = ['PHP', 'Java', 'C#', 'Python', 'JavaScript', 10];
let languages3: string[] = ['PHP', 'Java', 'C#', 'Python', 'JavaScript'];
let years: Array<number> = [2023, 2022, 2021, 2020, 2019, 2018, 2017, 2016];
// object = objetos, propriedades, funcionalidades (grupos de informações)
...
let statusUser: statusUserEnum = statusUserEnum.pending;
